...
col_map = {
    ...
    "CAPEX (w/ VAT)": "CAPEX (KDV Dahil)",
    "Delta NWC": "İşletme Sermayesi Değ.",
    "Debt Principal": "Anapara Ödemesi",
    "Debt Proceeds": "Kredi Kullanımı",
    "Equity Injection": "Özkaynak Enjeksiyonu",
